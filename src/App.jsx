  ...
  if (isTermsRoute) {
    return (
      <LegalScreen
        title="Terms of Use"
        updated="Last updated: April 2026"
        intro="By creating an account or using Curiosity Engine, you agree to these Terms of Use. Please read them carefully. These terms apply to parents and guardians who register accounts on behalf of children."
        sections={[
          {
            heading: "1. Who Can Use This Service",
            body: "Curiosity Engine is designed for children aged 4–12, under direct parental or guardian supervision. To create an account, you must:",
            items: [
          ...
          },
          {
            ...
            body: "Curiosity Engine offers a free tier and a paid subscription plan.",
            items: [
          ...
          },
          {
            ...
            body: "All content generated by Curiosity Engine — including stories, explanations, and quiz questions — is produced with the assistance of AI and is provided for personal, non-commercial educational use only.",
            items: [
              "You may not reproduce, distribute, or sell content from the app without our written consent",
              "Curiosity Engine retains ownership of the app, its design, and its underlying systems",
              "You retain no rights to AI-generated content beyond personal use",
            ],
          },
          {
            heading: "5. Acceptable Use",
            body: "You agree not to use Curiosity Engine to:",
            items: [
          ...
          },
          {
            ...
            items: [
              ...
              "Report any content that seems inappropriate via hello@curiosityengine.kids",
            ],
          },
          {
            heading: "7. Limitation of Liability",
            body: "To the extent permitted by law, Curiosity Engine and its operators are not liable for any indirect, incidental, or consequential damages arising from your use of the service. We do not guarantee that the app will be error-free or uninterrupted. Nothing in these terms limits your rights under the Australian Consumer Law.",
          },
          {
          ...
          {
            heading: "9. Contact",
            body: "If you have questions about these terms, please contact us at hello@curiosityengine.kids.",
          },
        ]}
      />
    );
