        ...
        sections={[
          {
            ...
            items: [
              ...
              "Parent-selected child interests (for topic-based curiosity prompts)",
          ...
          },
          {
            ...
            body: "We use data to:",
            items: [
              "Provide AI-generated answers, stories, quizzes, and learning experiences",
              "Personalise content using a child's age range and parent-selected interests — these are sent to our AI provider (OpenAI) to tailor question generation",
          ...
          },
          {
            ...
            body: "We use the following trusted service providers. Each receives only the minimum data necessary to perform their role:",
            items: [
              "Supabase — authentication and database hosting",
              "OpenAI — AI content generation. A child's age range and parent-selected interests are sent to OpenAI to generate personalised questions and learning content. No child names or contact details are sent.",
          ...
          },
          {
            ...
            body: "We retain data for as long as your account is active or as needed to provide the service:",
            items: [
              "Child profiles and interests are stored until you delete the profile or close your account",
              "AI-generated content is cached temporarily (up to 24 hours) to reduce duplicate API calls; it is not linked to a child identity in the cache",
              "Search history is retained until you delete it via Privacy Controls in the parent portal",
              "Payment records are retained as required by law (typically 7 years)",
              "Deleting a child profile permanently removes their interests, history, and badges",
            ],
          },
          {
            heading: "8. Contact",
            body: "If you have questions about this Privacy Policy, contact us at hello@whyroo.com.",
          },
        ]}
      />
    );
    ...
    staticRouteContent = (
      <LegalScreen
        ...
        sections={[
          ...
          {
            heading: "4. AI Personalisation",
            body: "Whyroo uses AI to personalise your child's learning experience. Specifically:",
            items: [
              "A child's age range and parent-selected interests are sent to OpenAI's API to generate topic-relevant questions, stories, quizzes, and explanations",
              "No child names, contact details, or precise location data are sent to AI providers",
              "AI-generated responses are filtered for age-appropriateness before being shown to children",
              "By selecting interests for your child, you consent to those interests being used for AI-powered personalisation as described in our Privacy Policy",
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              "Remember that Whyroo uses AI and can sometimes make mistakes, so important answers should be checked by a parent or guardian",
...
const PREVIEW_EXAMPLES = [
  {
    ...
    quote: "Oh... that's why stars sparkle!",
  },
  {
    emoji: "🏏",
    ...
    quote: "Oh... that's why the ball swings!",
  },
  {
    emoji: "🦕",
    ...
    quote: "Ohhh... that's why dinosaurs got huge!",
  },
  {
    emoji: "🌊",
    ...
    quote: "So that's why ocean water tastes salty!",
  },
];
    ...
    <div className="min-h-[100dvh] bg-gradient-to-br from-sky-100 via-purple-50 to-pink-100 text-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <section className="bg-white/90 backdrop-blur rounded-3xl shadow-sm border border-purple-100 p-6 sm:p-10 text-center mb-8 sm:mb-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold leading-tight text-purple-800 mb-4">
            Help your child understand the "why" behind what they see and do every day
          </h1>
          <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto mb-6">
            From cricket to everyday life, kids start noticing patterns and explaining things better.
          </p>
          <button
          ...
          <div className="mt-7 max-w-md mx-auto text-left rounded-2xl border border-purple-100 bg-white shadow-sm p-4 sm:p-5">
            ...
            <p className="text-xs text-slate-500 italic mb-3">
              Kids often say: "{PREVIEW_EXAMPLES[previewIndex].quote || "Oh... now I get it!"}"
            </p>
        ...
        <section className="bg-white rounded-3xl border border-purple-100 p-6 sm:p-8 mb-6">
          <h2 className="text-2xl sm:text-3xl font-black text-purple-800 mb-2">Why Whyroo</h2>
          <p className="text-sm sm:text-base text-slate-500 mb-5">Three ways Whyroo helps kids build real understanding.</p>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                icon: "🌍",
                title: "Helps kids think, not just answer",
                desc: "Kids learn to connect cause and effect, not just repeat facts.",
              },
              {
                icon: "🧭",
                title: "Turns everyday moments into learning",
                desc: "What they see in sport, school, and daily life becomes a chance to understand how things work.",
              },
              {
                icon: "🗣️",
                title: "Turns screen time into thinking time",
                desc: "Questions become ideas kids can explain, discuss, and apply in real life.",
              },
            ].map(({ icon, title, desc }) => (
        ...
        <section className="bg-white rounded-3xl border border-purple-100 p-6 sm:p-8 mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { icon: "💬", title: "Ask what they are curious about", desc: "Start with any question your child notices in the real world." },
              { icon: "📖", title: "Understand through simple explanations and real-life examples", desc: "Whyroo breaks big ideas into clear, age-appropriate explanations kids can actually follow." },
              { icon: "🧪", title: "Try it in the real world", desc: "Turn understanding into action with simple activities and everyday observation." },
        ...
        <section className="bg-white rounded-3xl border border-purple-100 p-6 sm:p-8 mb-6">
          ...
          <ul className="grid gap-3 sm:grid-cols-2 text-slate-700 font-semibold">
            ...
            <li className="rounded-xl bg-purple-50 border border-purple-100 px-4 py-3">Dual-layer safety checks keep content child-appropriate</li>
          </ul>
        </section>

        <section className="bg-white rounded-3xl border border-purple-100 p-6 sm:p-8 mb-6">
          <h2 className="text-2xl sm:text-3xl font-black text-purple-800 mb-2">Good for kids. Great for families.</h2>
          <p className="text-sm sm:text-base text-slate-500 mb-5">Small questions often lead to the best conversations at home.</p>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                icon: "✨",
                title: "Better conversations at home",
                desc: "Use your child's questions to have richer, more thoughtful chats together.",
              },
              {
                icon: "💬",
                title: "Kids start explaining their thinking more clearly",
                desc: "As understanding grows, kids begin describing ideas in their own words.",
              },
              {
                icon: "🙌",
                title: "A window into how your child thinks",
                desc: "See what they keep asking about and how their thinking is developing.",
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} className="rounded-2xl bg-purple-50 border border-purple-100 p-4">
                <p className="text-2xl mb-3">{icon}</p>
        ...
        <section className="bg-white rounded-3xl border border-purple-100 p-6 sm:p-8 mb-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-6">
            ...
            <div className="rounded-2xl border border-purple-200 bg-purple-50 p-5">
              ...
              <p className="text-lg font-bold text-slate-700 mb-1">Unlimited curiosity moments</p>
              ...
              <p className="mt-1 text-xs text-slate-500">Less than a single tennis lesson. A lifetime of curiosity.</p>
            </div>
          </div>
